...
export function LiveChat() {
    ...
    return (
        <div className="w-full overflow-hidden rounded-b-2xl border-x border-b border-gray-200 bg-gray-50 shadow-sm relative -mt-4 pt-4 z-0">
            {/* Header */}
            ...
            {/* Chat Area */}
            <ScrollArea className="h-[200px] bg-gray-50 p-4">
